...
use bookmarks_but_better_vault_core::{BookmarkNode, Id, scan};
...
fn a_bare_relative_root_resolves_against_the_working_directory_and_still_refuses_links() {
    ...
    workspace.write(
        "vault/.bookmarks-but-better-folder.md",
    ...
    workspace.write(
        "outside/.bookmarks-but-better-folder.md",
        folder_source("0uts1de0", None),
    );
    workspace.write(
