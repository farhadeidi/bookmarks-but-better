    ...
    >
      <section className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          . Any file sync becomes a bookmark sync — no account required.
        </p>
        <p className="text-sm leading-relaxed text-muted-foreground">
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1.5 py-0.5 text-xs">sudo</code>,
          nothing system-wide. Pipe into{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 text-xs">bash</code>,
          not <code className="rounded bg-muted px-1.5 py-0.5 text-xs">sh</code>
          . The installer finishes by running{" "}
          <code className="rounded bg-muted px-1.5 py-0.5 text-xs">setup</code>,
          which asks where your vault should live and which port to serve.
        </p>
      </section>
  ...
  --vault archive=~/vaults/archive`}
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          ...
          symlink. Your vault is a directory of Markdown files the installer has
          never heard of — it stays exactly where you put it.
        </p>
        <p className="text-sm leading-relaxed text-muted-foreground">
